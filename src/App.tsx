    ...
    <div 
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-6 py-8 md:py-12">
        ...
        <section className="mb-16">
          ...
          <Link
            to="/resume"
            className="inline-flex items-center gap-2 text-indigo-300 hover:text-indigo-200 font-medium text-sm bg-indigo-900/30 px-4 py-2 rounded-full border border-indigo-700/50 hover:bg-indigo-800/40 transition-all mt-4"
          >
            📄 View Resume
          </Link>
        </section>
